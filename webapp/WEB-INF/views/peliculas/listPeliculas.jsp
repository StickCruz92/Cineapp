...
<body>
	...
	<div class="container theme-showcase" role="main">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<c:forEach var="pelicula" items="${peliculas.content}">
					<tr>
						...
						<td><a href="${urlPeliculas}/edit/${pelicula.id}"
							class="btn btn-success btn-sm" role="button" title="Edit"><span
								class="glyphicon glyphicon-pencil"></span></a> <a
							href="${urlPeliculas}/delete/${pelicula.id}"
		...
		Total Peliculas: ${totalElements} - Page ${currentPage} of ${totalPages}

		<nav aria-label="">
			<ul class="pager">
				<c:if test="${peliculas.number > 0}">
					<li><a
						href="${urlPeliculas}/indexPaginate?page=${(peliculas.number + 1) - 1}">Anterior</a></li>
				</c:if>
				...
				<c:if test="${peliculas.number + 1 < totalPages}">
					<li><a
						href="${urlPeliculas}/indexPaginate?page=${(peliculas.number + 1) + 1}">Siguiente</a></li>
				</c:if>
			</ul>
		</nav>
