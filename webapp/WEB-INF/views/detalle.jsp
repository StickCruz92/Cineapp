		...
		<div class="container theme-showcase" role="main">
			...
			<div class="container marketing">
				...
				<div class="row">
					<div class="col-sm-3">
						<p class="text-center">
							<img class="img-rounded" " src="${urlPublic}/images/${pelicula.imagen}" alt="${pelicula.titulo}" width="155" height="220">            
						</p>
					</div>
					<div class="col-sm-9">
						<div class="panel panel-default">
							...
							<div class="panel-body">                           
								<p>
									...
									Fecha Estreno: <td><fmt:formatDate value="${pelicula.fechaEstreno }" pattern="dd-MM-yyyy"/></td>                  
								</p> 
